...
struct MainView: View {
    ...
    var accelerometer = Accelerometer(fps: UserDefaults.standard.double(forKey: "graphFPS") == 0 ? 120.0 : UserDefaults.standard.double(forKey: "graphFPS"))
    ...
    var body: some View {
        VStack {
            ...
            Text("version 1.4.1").font(.custom("small",size:15))
            Text("\n")
